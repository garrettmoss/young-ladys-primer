...
import { getContent, isContentAvailable, ResolvedChoice, ContentContext } from './content/index';
          ...
          <div className="manuscript-page p-10">
            ...
            {contentKey === 'settings' && (
              <SettingsPanel
                ...
                ageRevisedDate={ageRevisedDate}
                currentAge={currentAge}
                settingsAgeInput={settingsAgeInput}
                setSettingsAgeInput={setSettingsAgeInput}
                ...
                onEditAgeClick={handleEditAgeClick}
                onSettingsAgeSave={handleSettingsAgeSave}
                onCancelAgeEdit={handleCancelAgeEdit}
            ...
            {currentContent.choices.length > 0 && (
              <div className="space-y-3 mt-6">
                ...
                {currentContent.choices.map((choice: ResolvedChoice, index: number) => {
                  const isActionAvailable = isContentAvailable(choice.action, contentContext);
